...
indicator_summary_polot <- ggplot(distribution_df,
  ...
  geom_segment(aes(x = 0, xend = 1, y = indicator, yend = indicator),
               linewidth = 6, colour = "#e6f6f5") +
  geom_text(data = distribution_av,
            aes(label = "I"), family = "Inter",
            colour = "#666666", size = 10) +
  geom_text(aes(label = "I"), fontface = "bold", family = "Inter",
            colour = "#009d94", size = 5) +
  geom_text(data = distribution_max,
            aes(label = cc_iso3c), family = "Inter",
            colour = "#444444", size = 4, hjust = 0, nudge_x = 0.01) +
  annotate(
  ...
  annotate(
    ...
    size = 10, family = "Inter", fontface = "bold", colour = "#009d94"
  ) +
  annotate(
    geom = "text",
    x = distribution_av$value[distribution_av$indicator == "Capabilities"],
    y = 12.75, label = "InCiSE\naverage", vjust = 0,
    size = 4, family = "Inter", colour = "#444444"
  ) +
  annotate(
    geom = "text", x = 1, y = 12.75, label = "Highest\nscoring\ncountry",
    hjust = 0, size = 4, family = "Inter", vjust = 0, colour = "#444444"
  ) +
  theme_void() +
...
render_svg(
  indicator_summary_polot, width = 700, height = 600,
  alt_text = paste(
    "A bar chart summarising the distribution of country scores across the 12",
    "InCiSE indicators. Green vertical bars show the individual scores of the",
