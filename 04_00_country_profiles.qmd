...
This chapter provides a visual summary of each country's results from the 2019
edition  of the InCiSE Index. For each country, there is a bar chart showing
its position in the overall Index, as well as a ‘radar chart’ showing their
scores for each indicator compared with the InCiSE average. The radar charts
highlight where a country performs particularly well compared to the average
and where further analysis or attention may be beneficial.
...
This content was presented as the introduction to chapter 4 in the original
2019 publication.
:::
